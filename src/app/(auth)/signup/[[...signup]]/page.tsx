        ...
        <SignUp
          appearance={{
            elements: {
              ...
              formButtonPrimary: "bg-sage hover:bg-sage/90 shadow-none rounded-lg h-11 text-sm font-medium transition-colors",
              formFieldInput: "border-ink/10 focus:border-sage/50 focus:ring-1 focus:ring-sage/20 rounded-lg h-11 transition-colors",
